...
int main(int argc, char *argv[]) {
	...
	// if((bind(raw_socket, (struct sockaddr *)&saddr , sizeof(saddr))) == -1) error("bind: ");
	...
	while (true) {
		...
		ethhdr *eth = (ethhdr *) buff;/* for IP packets proto is 0x800 ETH_P_IP */
		iphdr *ip = (struct iphdr*)(buff + sizeof(struct ethhdr));/* extracting IP header */
